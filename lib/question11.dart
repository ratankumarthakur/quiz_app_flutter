...
class _question11State extends State<question11> {
  ...
  static String s110="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                              //keeps first submitted constants.ans10wer

  late DateTime startTime10;
  late DateTime endTime10;
  ...
  void initState() {
    super.initState();
    startTimer();
    startTime10 = DateTime.now();
    //globalStartTime = startTime10;
  }
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[9]["s"]}";                  //correct constants.ans10wer is stored in q
                        return Text("${snapsnot.data.docs[9]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s110=s1;
                  if(constants.aa10=="Submit"){
                    constants.option_color101=Colors.pink.shade200;
                    constants.option_color102=Colors.white;
                    constants.option_color103=Colors.white;
                    constants.option_color104=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color101,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s110=s2;
                  if(constants.aa10=="Submit"){
                    constants.option_color102=Colors.pink.shade200;
                    constants.option_color101=Colors.white;
                    constants.option_color103=Colors.white;
                    constants.option_color104=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color102,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s110=s3;
                  if(constants.aa10=="Submit"){
                    constants.option_color103=Colors.pink.shade200;
                    constants.option_color102=Colors.white;
                    constants.option_color101=Colors.white;
                    constants.option_color104=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color103,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s110=s4;
                  if(constants.aa10=="Submit"){
                    constants.option_color104=Colors.pink.shade200;
                    constants.option_color102=Colors.white;
                    constants.option_color103=Colors.white;
                    constants.option_color101=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color104,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color10,onPressed: (){
                  setState(() {
                    endTime10 = DateTime.now();
                    if(s110!=""){
                      constants.aa10="Submitted";
                      constants.button_color10=Colors.pink.shade200;
                    }
                  });
                  constants.count10++;
                  if(s110==""){
                  ...
                  else if(constants.count10>1){
                    print("already submitted");
                    print(constants.ans10);
                    //final  constants.ans10=s;
                  }
                  else if(constants.count10==1){
                    setState(() {
                      constants.ans10=s110;
                    });
                    print(constants.ans10);
                    if (startTime10 != null && endTime10 != null ) {
                      Duration timeTaken = endTime10.difference(startTime10);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans10==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans10==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans10==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa10,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question12()));},
