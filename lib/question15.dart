...
class _question15State extends State<question15> {
  ...
  static String s114="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                              //keeps first submitted constants.ans14wer

  late DateTime startTime14;
  late DateTime endTime14;
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[13]["s"]}";                  //correct constants.ans14wer is stored in q
                        return Text("${snapsnot.data.docs[13]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s114=s1;
                  if(constants.aa14=="Submit"){
                    constants.option_color141=Colors.pink.shade200;
                    constants.option_color142=Colors.white;
                    constants.option_color143=Colors.white;
                    constants.option_color144=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color141,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s114=s2;
                  if(constants.aa14=="Submit"){
                    constants.option_color142=Colors.pink.shade200;
                    constants.option_color141=Colors.white;
                    constants.option_color143=Colors.white;
                    constants.option_color144=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color142,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s114=s3;
                  if(constants.aa14=="Submit"){
                    constants.option_color143=Colors.pink.shade200;
                    constants.option_color142=Colors.white;
                    constants.option_color141=Colors.white;
                    constants.option_color144=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color143,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s114=s4;
                  if(constants.aa14=="Submit"){
                    constants.option_color144=Colors.pink.shade200;
                    constants.option_color142=Colors.white;
                    constants.option_color143=Colors.white;
                    constants.option_color141=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color144,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color14,onPressed: (){
                  setState(() {
                    endTime14 = DateTime.now();
                    if(s114!=""){
                      constants.aa14="Submitted";
                      constants.button_color14=Colors.pink.shade200;
                    }
                  });
                  constants.count14++;
                  if(s114==""){
                  ...
                  else if(constants.count14>1){
                    print("already submitted");
                    print(constants.ans14);
                    //final  constants.ans14=s;
                  }
                  else if(constants.count14==1){
                    setState(() {
                      constants.ans14=s114;
                    });
                    print(constants.ans14);
                    if (startTime14 != null && endTime14 != null ) {
                      Duration timeTaken = endTime14.difference(startTime14);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans14==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans14==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans14==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa14,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question16()));},
