...
class _question9State extends State<question9> {
  ...
  static String s19="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                           //keeps first submitted constants.ans9wer

  late DateTime startTime9;
  late DateTime endTime9;
  ...
  void initState() {
    super.initState();
    startTimer();
    startTime9 = DateTime.now();
    //globalStartTime = startTime9;
  }
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[8]["s"]}";                  //correct constants.ans9wer is stored in q
                        return Text("${snapsnot.data.docs[8]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s19=s1;
                  if(constants.aa9=="Submit"){
                    constants.option_color91=Colors.pink.shade200;
                    constants.option_color92=Colors.white;
                    constants.option_color93=Colors.white;
                    constants.option_color94=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color91,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s19=s2;
                  if(constants.aa9=="Submit"){
                    constants.option_color92=Colors.pink.shade200;
                    constants.option_color91=Colors.white;
                    constants.option_color93=Colors.white;
                    constants.option_color94=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color92,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s19=s3;
                  if(constants.aa9=="Submit"){
                    constants.option_color93=Colors.pink.shade200;
                    constants.option_color92=Colors.white;
                    constants.option_color91=Colors.white;
                    constants.option_color94=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color93,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s19=s4;
                  if(constants.aa9=="Submit"){
                    constants.option_color94=Colors.pink.shade200;
                    constants.option_color92=Colors.white;
                    constants.option_color93=Colors.white;
                    constants.option_color91=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color94,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color9,onPressed: (){
                  setState(() {
                    endTime9 = DateTime.now();
                    if(s19!=""){
                      constants.aa9="Submitted";
                      constants.button_color9=Colors.pink.shade200;
                    }
                  });
                  constants.count9++;
                  if(s19==""){
                  ...
                  else if(constants.count9>1){
                    print("already submitted");
                    print(constants.ans9);
                    //final  constants.ans9=s;
                  }
                  else if(constants.count9==1){
                    setState(() {
                      constants.ans9=s19;
                    ...
                    print(constants.ans9);
                    if (startTime9 != null && endTime9 != null ) {
                      Duration timeTaken = endTime9.difference(startTime9);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans9==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans9==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans9==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa9,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question11()));},
