...
class _question14State extends State<question14> {
  ...
  static String s113="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                          //keeps first submitted constants.ans13wer

  late DateTime startTime13;
  late DateTime endTime13;
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[12]["s"]}";                  //correct constants.ans13wer is stored in q
                        return Text("${snapsnot.data.docs[12]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s113=s1;
                  if(constants.aa13=="Submit"){
                    constants.option_color131=Colors.pink.shade200;
                    constants.option_color132=Colors.white;
                    constants.option_color133=Colors.white;
                    constants.option_color134=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color131,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s113=s2;
                  if(constants.aa13=="Submit"){
                    constants.option_color132=Colors.pink.shade200;
                    constants.option_color131=Colors.white;
                    constants.option_color133=Colors.white;
                    constants.option_color134=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color132,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s113=s3;
                  if(constants.aa13=="Submit"){
                    constants.option_color133=Colors.pink.shade200;
                    constants.option_color132=Colors.white;
                    constants.option_color131=Colors.white;
                    constants.option_color134=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color133,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s113=s4;
                  if(constants.aa13=="Submit"){
                    constants.option_color134=Colors.pink.shade200;
                    constants.option_color132=Colors.white;
                    constants.option_color133=Colors.white;
                    constants.option_color131=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color134,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color13,onPressed: (){
                  setState(() {
                    endTime13 = DateTime.now();
                    if(s113!=""){
                      constants.aa13="Submitted";
                      constants.button_color13=Colors.pink.shade200;
                    }
                  });
                  constants.count13++;
                  if(s113==""){
                  ...
                  else if(constants.count13>1){
                    print("already submitted");
                    print(constants.ans13);
                    //final  constants.ans13=s;
                  }
                  else if(constants.count13==1){
                    setState(() {
                      constants.ans13=s113;
                    });
                    print(constants.ans13);
                    if (startTime13 != null && endTime13 != null ) {
                      Duration timeTaken = endTime13.difference(startTime13);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans13==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans13==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans13==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa13,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question15()));},
