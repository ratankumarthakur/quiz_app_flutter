...
class _question5State extends State<question5> {
  ...
  static String s15="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                             //keeps first submitted constants.ans5wer

  late DateTime startTime5;
  late DateTime endTime5;
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[4]["s"]}";                  //correct constants.ans5wer is stored in q
                        return Text("${snapsnot.data.docs[4]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s15=s1;
                  if(constants.aa5=="Submit"){
                    constants.option_color51=Colors.pink.shade200;
                    constants.option_color52=Colors.white;
                    constants.option_color53=Colors.white;
                    constants.option_color54=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color51,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s15=s2;
                  if(constants.aa5=="Submit"){
                    constants.option_color52=Colors.pink.shade200;
                    constants.option_color51=Colors.white;
                    constants.option_color53=Colors.white;
                    constants.option_color54=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color52,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s15=s3;
                  if(constants.aa5=="Submit"){
                    constants.option_color53=Colors.pink.shade200;
                    constants.option_color52=Colors.white;
                    constants.option_color51=Colors.white;
                    constants.option_color54=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color53,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s15=s4;
                  if(constants.aa5=="Submit"){
                    constants.option_color54=Colors.pink.shade200;
                    constants.option_color52=Colors.white;
                    constants.option_color53=Colors.white;
                    constants.option_color51=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color54,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color5,onPressed: (){
                  setState(() {
                    endTime5 = DateTime.now();
                    if(s15!=""){
                      constants.aa5="Submitted";
                      constants.button_color5=Colors.pink.shade200;
                    }
                  });
                  constants.count5++;
                  if(s15==""){
                  ...
                  else if(constants.count5>1){
                    print("already submitted");
                    print(constants.ans5);
                    //final  constants.ans5=s;
                  }
                  else if(constants.count5==1){
                    setState(() {
                      constants.ans5=s15;
                    ...
                    print(constants.ans5);
                    if (startTime5 != null && endTime5 != null ) {
                      Duration timeTaken = endTime5.difference(startTime5);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans5==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans5==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans5==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa5,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question6()));},
