...
class _question13State extends State<question13> {
  ...
  static String s112="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                             //keeps first submitted constants.ans12wer

  late DateTime startTime12;
  late DateTime endTime12;
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[11]["s"]}";                  //correct constants.ans12wer is stored in q
                        return Text("${snapsnot.data.docs[11]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s112=s1;
                  if(constants.aa12=="Submit"){
                    constants.option_color121=Colors.pink.shade200;
                    constants.option_color122=Colors.white;
                    constants.option_color123=Colors.white;
                    constants.option_color124=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color121,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s112=s2;
                  if(constants.aa12=="Submit"){
                    constants.option_color122=Colors.pink.shade200;
                    constants.option_color121=Colors.white;
                    constants.option_color123=Colors.white;
                    constants.option_color124=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color122,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s112=s3;
                  if(constants.aa12=="Submit"){
                    constants.option_color123=Colors.pink.shade200;
                    constants.option_color122=Colors.white;
                    constants.option_color121=Colors.white;
                    constants.option_color124=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color123,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s112=s4;
                  if(constants.aa12=="Submit"){
                    constants.option_color124=Colors.pink.shade200;
                    constants.option_color122=Colors.white;
                    constants.option_color123=Colors.white;
                    constants.option_color121=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color124,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color12,onPressed: (){
                  setState(() {
                    endTime12 = DateTime.now();
                    if(s112!=""){
                      constants.aa12="Submitted";
                      constants.button_color12=Colors.pink.shade200;
                    }
                  });
                  constants.count12++;
                  if(s112==""){
                  ...
                  else if(constants.count12>1){
                    print("already submitted");
                    print(constants.ans12);
                    //final  constants.ans12=s;
                  }
                  else if(constants.count12==1){
                    setState(() {
                      constants.ans12=s112;
                    });
                    print(constants.ans12);
                    if (startTime12 != null && endTime12 != null ) {
                      Duration timeTaken = endTime12.difference(startTime12);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans12==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans12==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans12==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa12,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question14()));},
