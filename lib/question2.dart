...
class _question2State extends State<question2> {
  ...
  static String s12="";                                                                //stores user solution
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[1]["s"]}";                  //correct answer is stored in q
                        return Text("${snapsnot.data.docs[1]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s12=s1;
                  if(constants.aa2=="Submit"){
                    constants.option_color21=Colors.pink.shade200;
                    constants.option_color22=Colors.white;
                    constants.option_color23=Colors.white;
                    constants.option_color24=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color21,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s12=s2;
                  if(constants.aa2=="Submit"){
                    constants.option_color22=Colors.pink.shade200;
                    constants.option_color21=Colors.white;
                    constants.option_color23=Colors.white;
                    constants.option_color24=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color22,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s12=s3;
                  if(constants.aa2=="Submit"){
                    constants.option_color23=Colors.pink.shade200;
                    constants.option_color22=Colors.white;
                    constants.option_color21=Colors.white;
                    constants.option_color24=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color23,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s12=s4;
                  if(constants.aa2=="Submit"){
                    constants.option_color24=Colors.pink.shade200;
                    constants.option_color22=Colors.white;
                    constants.option_color23=Colors.white;
                    constants.option_color21=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color24,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color2,onPressed: (){
                  setState(() {
                    endTime2 = DateTime.now();
                    if(s12!=""){
                      constants.aa2="Submitted";
                      constants.button_color2=Colors.pink.shade200;
                    }
                  });
                  constants.count2++;
                  if(s12==""){
                  ...
                  else if(constants.count2>1){
                    print("already submitted");
                    print(constants.ans2);
                    //final  ans=s;
                  }
                  else if(constants.count2==1){
                    setState(() {
                    ...
                    if (startTime2 != null && endTime2 != null ) {
                      Duration timeTaken = endTime2.difference(startTime2);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans2==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans2==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans2==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa2,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question3()));},
