...
class _question3State extends State<question3> {
  ...
  static String s13="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                           //keeps first submitted constants.ans3wer

  late DateTime startTime3;
  late DateTime endTime3;
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[2]["s"]}";                  //correct constants.ans3wer is stored in q
                        return Text("${snapsnot.data.docs[2]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s13=s1;
                  if(constants.aa3=="Submit"){
                    constants.option_color31=Colors.pink.shade200;
                    constants.option_color32=Colors.white;
                    constants.option_color33=Colors.white;
                    constants.option_color34=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color31,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s13=s2;
                  if(constants.aa3=="Submit"){
                    constants.option_color32=Colors.pink.shade200;
                    constants.option_color31=Colors.white;
                    constants.option_color33=Colors.white;
                    constants.option_color34=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color32,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s13=s3;
                  if(constants.aa3=="Submit"){
                    constants.option_color33=Colors.pink.shade200;
                    constants.option_color32=Colors.white;
                    constants.option_color31=Colors.white;
                    constants.option_color34=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color33,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s13=s4;
                  if(constants.aa3=="Submit"){
                    constants.option_color34=Colors.pink.shade200;
                    constants.option_color32=Colors.white;
                    constants.option_color33=Colors.white;
                    constants.option_color31=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color34,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color3,onPressed: (){
                  setState(() {
                    endTime3 = DateTime.now();
                    if(s13!=""){
                      constants.aa3="Submitted";
                      constants.button_color3=Colors.pink.shade200;
                    }
                  });
                  constants.count3++;
                  if(s13==""){
                  ...
                  else if(constants.count3>1){
                    print("already submitted");
                    print(constants.ans3);
                    //final  constants.ans3=s;
                  }
                  else if(constants.count3==1){
                    setState(() {
                      constants.ans3=s13;
                    ...
                    if (startTime3 != null && endTime3 != null ) {
                      Duration timeTaken = endTime3.difference(startTime3);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans3==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans3==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans3==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa3,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question4()));},
