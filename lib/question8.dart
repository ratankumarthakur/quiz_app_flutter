...
class _question8State extends State<question8> {
  ...
  static String s18="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                              //keeps first submitted constants.ans8wer

  late DateTime startTime8;
  late DateTime endTime8;
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[7]["s"]}";                  //correct constants.ans8wer is stored in q
                        return Text("${snapsnot.data.docs[7]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s18=s1;
                  if(constants.aa8=="Submit"){
                    constants.option_color81=Colors.pink.shade200;
                    constants.option_color82=Colors.white;
                    constants.option_color83=Colors.white;
                    constants.option_color84=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color81,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s18=s2;
                  if(constants.aa8=="Submit"){
                    constants.option_color82=Colors.pink.shade200;
                    constants.option_color81=Colors.white;
                    constants.option_color83=Colors.white;
                    constants.option_color84=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color82,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s18=s3;
                  if(constants.aa8=="Submit"){
                    constants.option_color83=Colors.pink.shade200;
                    constants.option_color82=Colors.white;
                    constants.option_color81=Colors.white;
                    constants.option_color84=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color83,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s18=s4;
                  if(constants.aa8=="Submit"){
                    constants.option_color84=Colors.pink.shade200;
                    constants.option_color82=Colors.white;
                    constants.option_color83=Colors.white;
                    constants.option_color81=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color84,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color8,onPressed: (){
                  setState(() {
                    endTime8 = DateTime.now();
                    if(s18!=""){
                      constants.aa8="Submitted";
                      constants.button_color8=Colors.pink.shade200;
                    }
                  });
                  constants.count8++;
                  if(s18==""){
                  ...
                  else if(constants.count8>1){
                    print("already submitted");
                    print(constants.ans8);
                    //final  constants.ans8=s;
                  }
                  else if(constants.count8==1){
                    setState(() {
                      constants.ans8=s18;
                    ...
                    print(constants.ans8);
                    if (startTime8 != null && endTime8 != null ) {
                      Duration timeTaken = endTime8.difference(startTime8);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans8==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans8==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans8==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa8,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question9()));},
