...
class _question4State extends State<question4> {
  ...
  static String s14="";                                                                //stores user solution
  static String q="";                                                                  //stores correct answer

  static String s1="";
  static String s2="";                                                                 //these four are temporary storages
  static String s3="";
  static String s4="";                                                            //keeps first submitted constants.ans4wer

  late DateTime startTime4;
  late DateTime endTime4;
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context,dynamic snapsnot){
                      if(snapsnot.hasData){
                        q="${snapsnot.data.docs[3]["s"]}";                  //correct constants.ans4wer is stored in q
                        return Text("${snapsnot.data.docs[3]["q"]}",style: const TextStyle(fontSize: 25),);       //displays question1
                      }else{
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s14=s1;
                  if(constants.aa4=="Submit"){
                    constants.option_color41=Colors.pink.shade200;
                    constants.option_color42=Colors.white;
                    constants.option_color43=Colors.white;
                    constants.option_color44=Colors.white;
                  }
                });
              },
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color41,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s14=s2;
                  if(constants.aa4=="Submit"){
                    constants.option_color42=Colors.pink.shade200;
                    constants.option_color41=Colors.white;
                    constants.option_color43=Colors.white;
                    constants.option_color44=Colors.white;
                  }
                });
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color42,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s14=s3;
                  if(constants.aa4=="Submit"){
                    constants.option_color43=Colors.pink.shade200;
                    constants.option_color42=Colors.white;
                    constants.option_color41=Colors.white;
                    constants.option_color44=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color43,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
            ...
            Padding(
              ...
              child: GestureDetector(onTap: (){
                setState(() {
                  s14=s4;
                  if(constants.aa4=="Submit"){
                    constants.option_color44=Colors.pink.shade200;
                    constants.option_color42=Colors.white;
                    constants.option_color43=Colors.white;
                    constants.option_color41=Colors.white;
                  }
                ...
                child: Container(width: double.infinity,
                  decoration: BoxDecoration(
                      color: constants.option_color44,
                      borderRadius: BorderRadius.circular(11)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(18.0),
              ...
              SizedBox(width: 100,height: 40,
                child: MaterialButton(
                    ...
                    color: constants.button_color4,onPressed: (){
                  setState(() {
                    endTime4 = DateTime.now();
                    if(s14!=""){
                      constants.aa4="Submitted";
                      constants.button_color4=Colors.pink.shade200;
                    }
                  });
                  constants.count4++;
                  if(s14==""){
                  ...
                  else if(constants.count4>1){
                    print("already submitted");
                    print(constants.ans4);
                    //final  constants.ans4=s;
                  }
                  else if(constants.count4==1){
                    setState(() {
                      constants.ans4=s14;
                    ...
                    if (startTime4 != null && endTime4 != null ) {
                      Duration timeTaken = endTime4.difference(startTime4);

                      // Adjust score based on time taken
                      if (timeTaken.inSeconds <= 5 && constants.ans4==q) {
                        constants.score += 5;
                      } else if (timeTaken.inSeconds <= 10 && constants.ans4==q) {
                        constants.score += 3;
                      } else if(timeTaken.inSeconds > 10 && constants.ans4==q){
                        constants.score += 1;
                      }
                    ...
                    child: Text(constants.aa4,style: const TextStyle(color: Colors.blue),)),
              ),
              ...
              SizedBox(width: 90,height: 40,
                child: MaterialButton(
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>const question5()));},
